    ...
    : PlayCardBehavioralTest(featureBuilder)
{
    ...
    public override string Description => "Opponent winning with ace, should play lowest trump";

    public override string AssertionDescription => "Should play lowest trump";
    ...
    {
        return chosenCard.Suit == RelativeSuit.Trump && chosenCard.Rank == Rank.Nine;
    }
}
