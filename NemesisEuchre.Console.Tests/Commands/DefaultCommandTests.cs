...
public class DefaultCommandTests
{
    ...
    public async Task RunAsync_WhenExecuted_DisplaysApplicationBanner()
    {
        ...
        mockSingleGameRunner.Setup(x => x.RunAsync(It.IsAny<bool>(), It.IsAny<CancellationToken>())).ReturnsAsync(game);
    ...
    public async Task RunAsync_WhenExecuted_CallsSingleGameRunner()
    {
        ...
        mockSingleGameRunner.Verify(o => o.RunAsync(It.IsAny<bool>(), It.IsAny<CancellationToken>()), Times.Once);
    }
    ...
    public async Task RunAsync_WithCountOne_UsesSingleGameRunner()
    {
        ...
        mockBatchGameOrchestrator.Verify(
            o => o.RunBatchAsync(It.IsAny<int>(), It.IsAny<IBatchProgressReporter>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()),
            Times.Never);
    }
    ...
    public async Task RunAsync_WithCountGreaterThanOne_UsesBatchGameOrchestrator()
    {
        ...
        mockBatchGameOrchestrator.Verify(
            o => o.RunBatchAsync(10, It.IsAny<IBatchProgressReporter>(), It.IsAny<bool>(), default),
            Times.Once);
        mockSingleGameRunner.Verify(o => o.RunAsync(It.IsAny<bool>(), It.IsAny<CancellationToken>()), Times.Never);
    }
    ...
    public async Task RunAsync_WithBatchExecution_PassesProgressReporter()
    {
        ...
        mockBatchGameOrchestrator.Verify(
            o => o.RunBatchAsync(5, It.IsNotNull<IBatchProgressReporter>(), It.IsAny<bool>(), default),
            Times.Once);
    }
}
